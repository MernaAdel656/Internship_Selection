...
* Plotting correlation heatmaps and data visualizations.
...
* **Stratified Sampling**: Implemented to preserve class distribution.
...
## 📈 Evaluation Metrics
The models were rigorously evaluated using:
* Accuracy
* Precision
* Recall
* F1-score
